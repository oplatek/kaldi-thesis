...
The~backward decoding (\term{hyp\_out} method) was called so often that almost no forward decoding was performed which lead to buffering the input audio in \ac{PyOnlineLatgenRecogniser} and $RTF > 1.0$.
