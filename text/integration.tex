...
We also implemented scripts which allow easy \ac{AM} training and testing \ac{AM} and \ac{LM} evaluation for Kaldi speech recognition in Alex \ac{SDS}.
...
As a results, the~\term{OnlineLatgenRecogniser} performs significantly better than our previous \ac{ASR} engines.
