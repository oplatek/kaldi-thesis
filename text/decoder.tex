...
Section~\ref{sec:impl} describes the~implementation and interface of the~\term{OnlineLatgenRecogniser}.
The interface of \term{OnlineLatgenRecogniser} reflects implementation of \term{OnlLatticeFasterDecoder} which is also introduced.
Next Section~\ref{sec:} describes on-line speech parametrisation and feature transformations, and Section~\ref{sec:} details word posterior lattice extraction.
...
\subsection{PyOnlineLatgenRecogniser}
\label{sec:pyext}
...
\section{On-line feature pre-processing} 
