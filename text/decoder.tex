...
The~\verb!C++! example in Listing~\ref{rec_usage.cc} shows a typical use of the~\term{OnlineLatgenRecogniser} interface.
...
\code{Example of the~decoder API}{C}{snippets/rec_usage.cc}
...
\begin{enumerate}
    \item {\it beam} \todo{default value and description}
    \item {\it max-active} \todo{default value and description}
    \item {\it max-mem} \todo{default value and description}
    \item {\it prune-interval} \todo{default value and description}
\end{enumerate}
