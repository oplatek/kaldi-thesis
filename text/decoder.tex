...
\label{sub:verb_c_}
The~\term{OnlineLatgenRecogniser} makes use of the~incremental speech pre-processing and modified \term{LatticeFasterDecoder}.
It provides the~following speech recognition interface:
\begin{itemize}
