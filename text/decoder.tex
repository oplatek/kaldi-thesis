...
The word posterior lattices are returned as instances of the OpenFST \cite{allauzen2007openfst} class.
The OpenFST implementation for Python is provided \term{pyfst} library \cite{pyfst2014url}.
In the ADSF we implemented conversion of the word posterior lattices to an~n-best list. 
