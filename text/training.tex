...
This chapter present new Kaldi acoustic modeling recipe for free Czech and English "\term{Vystadial}" data.
...
\begin{figure}[!htp]
    ...
    \caption{Fixed \term{tri2b\_bmmi} \ac{AM} and varying \ac{LM} training size.}
