...
In our case the acoustic models \term{mono}, \term{tri1}, \term{tri2a}
and \term{tri2b} are trained generatively.
Meaning the models are trained according \ac{MLE} criterion.
On the other hand the acoustic models \term{tri2b\_mmi}, \term{tri2b\_bmmi}
and \term{tri2b\_mpe} are trained discriminatively.
...
The speed of the decoding is not important at this moment.  The \term{gmm-latgen-faster} decoder is used for evaluation on testing data. 
...
\ml{datasets}
The experiments were performed on dataset called \term{Vystadial}\footnote{\todo{Add link to Vystadial dataset.}}.
