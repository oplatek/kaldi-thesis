...
The low \ac{WER} on Czech dataset may be explained be following reasons:
\begin{itemize}
    \item The mix of very different domain and recording conditions is hardly to model by both \ac{AM} and \ac{LM}. 
...
We want to roughly compare Kaldi and HTK on the Vystadial Czech and English datasets, since we are not familiar with Kaldi toolkit.
