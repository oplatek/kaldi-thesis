...
The training script as well as the source code of the \term{OnlineLatgenRecogniser} is currently merging into Kaldi repository\footnote{\url{http://sourceforge.net/p/kaldi/code/HEAD/tree/sandbox/oplatek2/src/dec-wrap/}}\footnote{\url{http://sourceforge.net/p/kaldi/code/HEAD/tree/sandbox/oplatek2/egs/vystadial/}}.
...
The training scripts, the \term{OnlineLatgenRecogniser} and its Python wrapper \term{PyOnlineLatgenRecogniser} was developed also under Apache, 2.0 license on Github\footnote{\url{https://github.com/UFAL-DSG/pykaldi}, \url{https://github.com/UFAL-DSG/pyfst}} 
...
% We would like to focus on acoustic modeling with \acl{DNN}.
