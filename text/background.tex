...
The combination of \ac{LDA} and \ac{MLLT} applies the feature transformation in two steps: \ac{LDA} reduces the feature dimension and \ac{MLLT} rotates the feature space \todo{so the classes after \ac{LDA}} has more diagonal covariance\cite{gopinath1998maximum}.
...
In Figure~\ref{fig:hmm_words} the transcription \term{how do you do} 
...
\todo{In addition, with minor modifications a Viterbi algorithm is used also for decoding in Kaldi.}
