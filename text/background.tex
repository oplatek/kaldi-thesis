...
It is convenient to output with each hypothesis a measure so one can see how good the hypothesis is in contrast to its alternatives or in absolute measure. 
