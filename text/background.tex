...
Research on field of speech recognition began more than \todo{30} years ago. The statistical approach based on \ac{HMM} established itself very early and nowadays it is de facto standard. If we speak about speech recognition in~this thesis we mean speech recognition based on Hidden Markov Models. 
...
\todo{Bayes rules: acoustic model $P(text|give acoustic signal)$,  \ac{LM} $P(text)$}
