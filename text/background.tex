...
\begin{figure}[!htp]
    ...
    \caption{Markov monophone model for three words. \todo{Can be used for explaining Viterbi.}}
    \label{fig:hmm_words} 
    \end{center}
\end{figure}
...
\begin{figure}[!htp]
    ...
    \caption{Small lattice. \todo{TODO draw it with Ipython}}
    \label{fig:toy_lat} 
    \end{center}
\end{figure}
