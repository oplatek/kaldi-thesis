...
$\epsilon$ transitions and beam search is used for selecting the most probable sequence.}
        \label{fig:hmm_alt} 
    \end{center}
\end{figure}

The search space of speech recognition problem with 
...
\todo{Combining AM and LM -> LM weight}
\todo{Formats}
\todo{Beam search - forward decoding.}
\todo{Backward decoding only for lattices.}

\todo{Hypothesis in one-best format can extracted from all presented hypothesis output formats.}
