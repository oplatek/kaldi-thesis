...
\todo{The parameters of \ac{HMM} can be estimated soft EM algorithm or by hard EM algorithm.
The Baum-Welch algorithm is soft EM algorithm.
The Viterbi algorithm is hard EM algorithm.}

\todo{Really? We use semi-continuous \ac{HMM}, meaning that the probability of generating 
acoustic features in given state is modeled by semi-continuous Gaussian distribution.}
